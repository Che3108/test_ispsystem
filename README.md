...
<p><b>Метод delete_arh()</b></p> выполняет удаление архива и распакованной информации. Удаление производится с помощью модулей os и shutil.
<p><b>Метод get_status()</b></p> собирает информацию о состоянии обработки на каждом этапе и, вместе с id архива, возращает его в видете готового json-объекта.

### my_server.py
my_server.py содержит класс обработчика запросов. Содержит три "ручки" (do_POST(), do_GET(), do_DELETE()).
